...
function getTagIcon(tag: string): React.ReactNode | null {
  ...
  const iconMap: Record<string, () => React.ReactNode> = {
    "react": () => Icons.react({ className: "size-4" }),
    "next.js": () => Icons.nextjs({ className: "size-4" }),
    "nextjs": () => Icons.nextjs({ className: "size-4" }),
    "typescript": () => Icons.typescript({ className: "size-4" }),
    "github": () => Icons.github({ className: "size-4" }),
    "android": () => Icons.android({ className: "size-4" }),
    "ios": () => Icons.apple({ className: "size-4" }),
    "apple": () => Icons.apple({ className: "size-4" }),
    "google": () => Icons.google({ className: "size-4" }),
    "aws": () => Icons.amazon({ className: "size-4" }),
    "django": () => Icons.django({ className: "size-4" }),
    "mysql": () => Icons.mysql({ className: "size-4" }),
    "postgresql": () => Icons.postgresql({ className: "size-4" }),
    "mongodb": () => Icons.mongodb({ className: "size-4" }),
    "angular": () => Icons.angular({ className: "size-4" }),
    "flutter": () => Icons.flutter({ className: "size-4" }),
    "dart": () => Icons.dart({ className: "size-4" }),
  };
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-end pb-16">
            <BlurFade delay={0.1}>
              <Link href="/#projects">
                <Button
                  variant="ghost"
                  className="mb-8 text-foreground/70 hover:text-foreground group"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {project.screenshots.map((screenshot, idx) => (
                  ...
                  >
                    ...
                    <div 
                      className="relative aspect-video bg-muted w-full h-full"
